    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<ClassListbean>() {
            ...
            public void onResponse(Call<ClassListbean> call, Response<ClassListbean> response) {
                ...
                ArrayAdapter<String> adp1 = new ArrayAdapter<String>(ComposeMessage.this,
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                call2.enqueue(new Callback<SectionListbean>() {
                    ...
                    public void onResponse(Call<SectionListbean> call, Response<SectionListbean> response) {
                        ...
                        ArrayAdapter<String> adp = new ArrayAdapter<String>(ComposeMessage.this,
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(ComposeMessage.this.getFragmentManager(), "DatePicker");
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(ComposeMessage.this.getFragmentManager(), "TimePicker");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pos == 0 || tv_date.getText().equals("Start Date") || tv_date1.getText().equals("End Date") || tv_time.getText().equals("Time")) {
                    ...
                    Toast.makeText(ComposeMessage.this, "Please select all fields!", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(ComposeMessage.this);
                            ...
                            call.enqueue(new Callback<CreateEventTechrBean>() {
                                ...
                                public void onResponse(Call<CreateEventTechrBean> call, Response<CreateEventTechrBean> response) {
                                    ...
                                    if (response.body().getStatus().equals("1")) {
                                        Toast.makeText(ComposeMessage.this, "Event has been Created Successfully", Toast.LENGTH_SHORT).show();
                                        finish();
                                    } else {
                                        Toast.makeText(ComposeMessage.this, "Event creation Failed!", Toast.LENGTH_SHORT).show();

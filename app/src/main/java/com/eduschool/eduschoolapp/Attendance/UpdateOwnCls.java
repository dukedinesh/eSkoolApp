...
public class UpdateOwnCls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = new GridLayoutManager(UpdateOwnCls.this, 1);
        ...
        adapter = new AdapterMrkAttndnc(UpdateOwnCls.this, list);
        ...
        Call<StudentListbean> call3 = cr.student_list(b.user_id, b.user_class, b.user_section);
                ...
                call3.enqueue(new Callback<UpdateAttendncBean>() {
                    ...
                    public void onResponse(Call<UpdateAttendncBean> call3, Response<UpdateAttendncBean> response) {
                        ...
                        if (response.body().getStatus().equals("1")){
                            Toast.makeText(UpdateOwnCls.this,"Attendance has been Updated Successfully ",Toast.LENGTH_SHORT).show();
                            finish();
                        }else {
                            Toast.makeText(UpdateOwnCls.this,"Attendance does not updated!",Toast.LENGTH_SHORT).show();
                            finish();
                        }

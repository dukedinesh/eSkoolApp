            ...
            call.enqueue(new Callback<BookListBean1>() {
                ...
                public void onResponse(Call<BookListBean1> call, Response<BookListBean1> response) {
                    ...
                    for (int i = 0; i < response.body().getBookList().get(0).getBookCategory().size(); i++) {
                        ...
                        text.setTextSize(TeacherLibrary2.this.getResources().getDimensionPixelSize(R.dimen.textView));
                        text.setPadding(TeacherLibrary2.this.getResources().getDimensionPixelSize(R.dimen.textPadding), TeacherLibrary2.this.getResources().getDimensionPixelSize(R.dimen.textPadding), TeacherLibrary2.this.getResources().getDimensionPixelSize(R.dimen.textPadding), TeacherLibrary2.this.getResources().getDimensionPixelSize(R.dimen.textPadding));
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        call.enqueue(new Callback<ReserveBookBean>() {
                          ...
                          if (response.body().getStatus().equals("1")){
                              ...
                              Toast.makeText(TeacherLibrary2.this,"Your Book is reserved successfully",Toast.LENGTH_SHORT).show();

                          }else {

                              Toast.makeText(TeacherLibrary2.this,"Book does not reserved!",Toast.LENGTH_SHORT).show();
                          }
